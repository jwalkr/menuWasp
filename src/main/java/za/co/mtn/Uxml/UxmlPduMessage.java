 ...
 *	Updated and modified: Yusuf Kaka MTN South Africa
 *
...
public class UxmlPduMessage extends UxmlMessage {
    ...
    final static int UPDU_CHILD_1	= 8; 
	final static int UPDU_MAX		= 9; 
    ...
    public UxmlPduMessage () {
		...
		m_pairs[UPDU_CHILD_1]   [UXML_NAME] = "VALUE";
    ...
    public void setCookie ( String cookie ) {
        m_pairs[UPDU_CHILD_1][UXML_VALUE] = cookie;
    }

    public String getCookie (  ) {
        return m_pairs[UPDU_CHILD_1][UXML_VALUE];
    }
